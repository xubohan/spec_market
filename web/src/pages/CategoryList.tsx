...
import { useSpecsByCategory } from '../lib/api';
...
export const CategoryListPage = () => {
  ...
  const { data, isLoading } = useSpecsByCategory(slug);
  ...
  return (
    <section className="flex flex-col gap-6">
      ...
      {!isLoading && !data?.items?.length && <EmptyState message="No specs under this category." />}
    </section>
  );
};
